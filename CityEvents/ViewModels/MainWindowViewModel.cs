...
namespace CityEvents.ViewModels
{
    public class MainWindowViewModel : ViewModelBase
    {
        ...
        {
            CityEvent[] events = Serializer<CityEvent[]>.Load("../../../events.xml"); // авалония - это прекрасный пример того, что планета стоит на трех китах, которые ходят исключительно на костылях, потому что из-за этой строчки постоянно появляется ошибка "System.Xaml.XamlException: Could not find file 'C:\Users\events.xml'"
